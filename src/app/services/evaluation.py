...
class EvaluationSample(BaseModel):
    ...
    ground_truth: str | None = Field(None, description="Reference answer if available")
...
class RAGASMetrics(BaseModel):
    ...
    answer_similarity: float | None = Field(None, ge=0.0, le=1.0, description="Semantic similarity score")
    answer_correctness: float | None = Field(None, ge=0.0, le=1.0, description="Answer correctness score")
...
class RAGASCallbackHandler(BaseCallbackHandler):
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs) -> None:
        ...
        if self.current_sample and "answer" in outputs:
            ...
            EvaluationSample(**self.current_sample)
